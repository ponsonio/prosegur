...
public class AnulacionInformeBO implements Serializable{
    ...
    public List<SdmEmpleado> buscarEmpleadosEmisores(){
     ...
     */
	 public String buscarLiquidacionXCorrelativo(){
		 ...
		 try {
			 ...
			 if (informe.isAnulado()) {
					...
					statusMessages.add(Severity.ERROR ,"El informe ya esta anulado");
	 ...
	 /**
	  * Busca las lquidaciones por emisor y rango de fechas, soporta la opción 'Todos'
	 ...
	 public String buscarLiquidacionesXRango(){
		 ...
		 if (this.sdmEmpleadoSelect.getId() == -1){
			...
			listRSdmInformeViaticos = sdmInformeViaticosHome.buscarInformesActivosXLiquidarXEmpleadoFechas(this.sdmEmpleadoSelect.getId() , this.fechaDesde , this.fechaHasta);
		 }
			...
			VistaSdmInformeViaticos vista ;
					 while(it.hasNext()){
						 ...
						 if (vista.selecionado){
							 ...
							 SdmInformeViaticos sdmInformeViaticos = sdmInformeViaticosHome.buscarInformeActivosXCorrelativo(vista.getId());
							 sdmInformeViaticosHome.anularInformeViaticos(sdmInformeViaticos);
							 statusMessages.add("Se anuló el informe : "+sdmInformeViaticos.getId());
						 }
					 }
					 listvistaSdmInformeViaticos = new ArrayList<VistaSdmInformeViaticos>();
